...
public class HeronsFormula
{
	public static void main( String[] args )
	{
		...
		System.out.println("A triangle with side 9,9,9 has an area of " + a);
...
// (2) w/function = 32 w/o function = 50
// (3) Easier to fix the file with the function
// (4) Easier to add to the function file